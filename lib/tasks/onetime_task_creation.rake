...
namespace :populate_data do
  ...
  task :task => :environment do
    ...
    Task.create!(name: "Aws", description: "Aws", official_documentation: "https://docs.aws.amazon.com/", video_link: "https://www.udemy.com/course/draft/362328/learn/lecture/13886254?start=0#overview")
    ...
    Task.create!(name: "Linux", description: "Linux", official_documentation: "", video_link: "https://www.udemy.com/course/complete-linux-training-course-to-get-your-dream-it-job/learn/lecture/20147642?start=0#overview")
    ...
    Task.create!(name: "EJB / Spring boot  + Test Cases", description: "EJB / Spring boot  + Test Cases", official_documentation: "https://www.tutorialspoint.com/ejb/index.htm", video_link: "")

    Task.create!(name: "GCP", description: "GCP", official_documentation: "", video_link: "https://www.udemy.com/course/google-cloud-professional-cloud-architect-certification/learn/lecture/26121442?start=0#overview")
    ...
    Task.create!(name: "Excel", description: "Excel", official_documentation: "", video_link: "https://www.udemy.com/course/useful-excel-for-beginners/learn/lecture/720152?start=0#overview")

    Task.create!(name: "Mongo DB", description: "Mongo DB", official_documentation: "https://www.w3schools.com/mongodb/", video_link: "")

    Task.create!(name: "Html + CSS + BootStrap", description: "Html + CSS + BootStrap", official_documentation: "https://getbootstrap.com/docs/5.3/forms/overview/", video_link: "")
