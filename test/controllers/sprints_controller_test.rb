...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference("Sprint.count") do
      post sprints_url, params: { sprint: { active: @sprint.active, end_date: @sprint.end_date, name: @sprint.name, start_date: @sprint.start_date } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { active: @sprint.active, end_date: @sprint.end_date, name: @sprint.name, start_date: @sprint.start_date } }
